...
<div class="col-sm-10 col-sm-offset-1">
	...
	<table id="promotion_table" class="table table-striped table-hover">
		<thead><tr><th>اسم</th><th>مرتبه الجديد</th><th>درجة الجديد</th><th>عنوان موضفی الجديد</th><th>راتب الجديد</th><th>مدة خدمة</th><th>عمل</th></tr></thead>
		<br/><br/>
		<b>
		<tbody>	
		<?php
	...
	<script type="text/javascript" charset="utf8" src="../../../need/DataTables/media/js/jquery.dataTables.js"></script>
  	<script src="../Javascript/prom_ar_us.js"></script>
