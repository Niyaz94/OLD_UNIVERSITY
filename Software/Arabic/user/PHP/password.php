...
<center><h3 class="white"><br><strong id="change_text" >يرجى تغير كلمة المرور عندما جئت لاول مرة</strong> </h3></center>
...
<form class="form-horizontal" role="form" method="post" action="#">
  ...
  <div class="form-group"><div id="div_username" class="col-md-6 has-error has-feedback">
    ...
    <div class="form-group"><div id="div_password" class="col-md-6 has-error has-feedback">
		<input class="form-control" id="password" name="password" type="text" placeholder="كلمة المرور">
		<span  id="span_password" class="glyphicon glyphicon-remove form-control-feedback"></span>
	</div></div>
  <div class="form-group"><button id="button_save" type="button" class="btn btn-primary col-md-6" disabled>حفض</button></div>
