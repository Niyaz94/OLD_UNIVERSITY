...
<div class="col-sm-10 col-sm-offset-1" >
     ...
     <div class="col-sm-12  col-xs-8">
         <div style="text-align: right;" class="col-sm-8  col-xs-8">
			<h3>اتصل بنا</h3>
            <p>ملء النموذج أدناه للاتصال بنا :</p><br><br>
         </div>
		...
		<form role="form"  method="post" class="col-sm-8 col-sm-offset-2 col-xs-6">
             <div class="form-group">
				<div id="div_subject" class="has-error has-feedback">
					<input type="text" id="subject" name="subject" placeholder="موضوع..." class="form-control">
             ...
             <div class="form-group">
				<div id="div_message" class="has-error has-feedback">
					<textarea id="message" name="message" placeholder="رسالة..." class=" form-control" rows="8" maxlength="250"></textarea>
             ...
             <button id="save" type="button" class="btn btn-primary col-sm-12 col-xs-12" disabled>إرسال رسالة</button>
			 <br>
