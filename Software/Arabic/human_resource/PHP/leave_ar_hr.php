...
<div class="container">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content" style="background-color: #454d60; ">  
		...
		<center><h3 style="color: white;">إدراج المعلومات </h3></center></div>
			...
			<b>
				 <div class="form-group">
					<div id="div_year" class="col-md-12 has-error has-feedback">
						<input id="year" class="form-control" type="number" placeholder="عام">
				...
				<div class="form-group">
					<div id="div_month" class="col-md-12 has-error has-feedback">
						<input id="month" class="form-control"  type="number" placeholder="شهر">
				...
				<div class="form-group">
					<div id="div_day" class="col-md-12 has-error has-feedback">
						<input id="day" class="form-control" type="number"  placeholder="يوم">
						<span  id="span_day" class="glyphicon glyphicon-remove form-control-feedback"></span>
					</div>
				</div>
			</b></form>
        </div>
        <div class="modal-footer" style="border-color: #454d60;"><button id="enter_save" type="button" class="btn btn-danger pull-right" disabled><span id="span_enter_save" class="glyphicon glyphicon-remove"></span>حفظ</button></div>
   </div></div></div>   
   ...
   <div class="modal fade" id="data_Modal" role="dialog" style="margin-left: auto; margin-right: auto; margin-top: 60px; ">
    <div class="modal-dialog modal-sm">
      <div class="modal-content" style="background-color: #454d60; ">  
        ...
        <div class="modal-body" style="border-color: #454d60;">	
			...
			<b>
				 <div class="form-group">
				     <label class="control-label col-sm-2" for="old">من عند:</label>
				...
				<div class="form-group">
				    <label class="control-label col-sm-2" for="new">إلى:</label>
        ...
        <div class="modal-footer" style="border-color: #454d60;"><button id="data_save" type="button" class="btn btn-success pull-right" > حفظ </button></div>
   </div></div></div>   
	...
	<script src="../Javascript/leave_ar_hr.js"></script>
