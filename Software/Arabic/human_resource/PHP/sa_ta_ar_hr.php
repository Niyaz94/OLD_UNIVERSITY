...
<div class="container">
			...
			<b>
				 <div class="form-group">
					<div id="div_basic" class="col-md-offset-3 col-md-6 has-error has-feedback">
						<input type="number" class="form-control text-center" id="basic" placeholder="راتب اساسي" title="راتب اساسي" data-placement="left">
				...
				<div class="form-group">
					<div id="div_salary_increase" class="col-md-offset-3 col-md-6 has-error has-feedback offset">
						<input type="number" class="form-control text-center" id="salary_increase" title="زيادة الراتب" placeholder="زيادة الراتب" data-placement="left">
				...
				<div class="form-group">
					 <div id="div_rank_year" class="col-md-offset-3 col-md-6 has-error has-feedback">
						<input type="number" class="form-control text-center" id="rank_year" title="السنة إلى رتبة جديدة"  placeholder="السنة إلى رتبة جديدة" data-placement="right">
	...
	<script src="../Javascript/sa_ta_ar_hr.js"></script>
</body>
</html>