...
<div class="container">
	...
	<div class="row">
	<br/><br/>
	<button type="button" id="add_new" class="btn btn-primary col-md-2" >إضافة شهادة جديدة</button>
	<br/><br/><br/><br/>
		...
		<table id="certificate_table" class="table table-striped table-hover" >
			<thead>	<?php
				echo "<tr class='colorheader'>";
					echo "<th>&nbsp;&nbsp;اسم الشهادة</th>";
					echo "<th>&nbsp;&nbsp;بدء درجة  </th>";
					echo "<th>&nbsp;&nbsp;بدء مرتبة  </th>";
					echo "<th>&nbsp;&nbsp;نهاية درجة </th>";
					echo "<th>&nbsp;&nbsp;نهاية مرتبة </th>";
					echo "<th>&nbsp;&nbsp;تقدیم فترة عام</th>";
					echo "<th>&nbsp;&nbsp;تقدیم فترة شهر</th>";
					echo "<th>&nbsp;&nbsp;عمل</th>";
				echo "</tr>";
			?></thead>
			<tbody><?php		
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="background-color: #454d60; ">  
		...
		<center><h3 style="color: white;">تغيير هذا الصف</h3></center></div>
			...
			<b>
				 <div class="form-group">
					<div id="div_start_rank" class="col-md-6 has-error has-feedback">
						<input id="start_rank" class="form-control" type="number" placeholder=" بدء درجة">
					...
					<div id="div_start_grade" class="col-md-6 has-error has-feedback">
						<input id="start_grade" class="form-control" type="number"  placeholder=" بدء مرتبة" >
				...
				<div class="form-group">
					<div id="div_end_rank" class="col-md-6 has-error has-feedback">
						<input id="end_rank" class="form-control"  type="number" placeholder="نهاية درجة">
					...
					<div id="div_end_grade" class="col-md-6 has-error has-feedback">
						<input id="end_grade" class="form-control" type="number" placeholder="نهاية مرتبة" >
				...
				<div class="form-group">
					<div id="div_year" class="col-md-6 has-error has-feedback">
						<input id="year" class="form-control" type="number"  placeholder="تقدیم فترة عام">
					...
					<div id="div_month" class="col-md-6 has-error has-feedback">
						<input id="month" class="form-control" type="number"  placeholder="تقدیم فترة شهر" >
				...
				<div class="form-group">
					<div id="div_name" class="col-md-6 has-error has-feedback">
						<input id="name" class="form-control"  type="text" placeholder="اسم الشهادة">
        ...
        <div class="modal-footer" style="border-color: #454d60;"><button id="save" type="button" class="btn btn-danger pull-right" disabled><span id="span_save" class="glyphicon glyphicon-remove"></span> حفظ</button></div>
   </div></div></div>   
	...
	<script src="../Javascript/ce_ru_ar_hr.js"></script>
