$(document).ready( function () {
	...
	$("#save_save").click(function(){
		...
		var order=[];
		if(id>0 && counter >= 1){//∆ÂùêÂù— ÂÌç ‰«ÊÂùﬂ œÌ«—Ì ‰Âùﬂ—«»ÊÊ ∆ÂùÊÂù ÂÌç „ÂùﬂÂù
	...
	$("#edit_reset").click(function(){//»Âùﬂ«—œ?  »? ê?—Ì‰ÂùÊÂù ›?—„ÂùﬂÂù ·Âù»? ‘?ÊÂùÌ ”Âù—Âù «
