$(document).ready( function () {
	...
	var value_id=["employee_id","new_salary","salary","new_rank","rank","new_grade","grade","new_S_date","S_date","new_barz","new_sarm"];
	...
	$('#new_annual').on("keyup mouseup",function(){//la table remove bakardet bo auae bzane data e ba tauaue daxel krdea
	...
	$('#new_salary,#old_salary,#new_rank,#old_rank,#new_grade,#old_grade,#new_annual_date,#old_annual_date').on("keyup mouseup",function(){	
		...
		if(check_id=="new_salary"){
			if(validation_number($(this).val(),10000000,1)==true)
