...
<div class="row content">
	...
	<table id="annual_table" class="table table-striped table-hover">
		<thead><tr><th>Name</th><th>Rank</th><th>Old Grade</th><th>New Grade</th><th>Annual Date</th><th>Action</th></tr></thead>
		<br/><br/>
		<b>
		<tbody>	
		<?php
      ...
      <div class="modal-content" style="background-color: #454d60; ">  
        ...
        <div class="modal-body" style="border-color: #454d60;">	
			...
			<b>
				...
				<div class="form-group">
					<div class="col-sm-6"> <input type="text" class="form-control text-center" id="title" title="Employee Title" readonly data-placement="left"></div>
					<div class="col-sm-6"> <input type="text" class="form-control text-center" id="qdam" title="Acceleration Number" readonly data-placement="right"></div>
				</div>  
			</b></form>
        </div>
	...
	<script type="text/javascript" charset="utf8" src="../../../need/DataTables/media/js/jquery.dataTables.js"></script>
  	<script src="../Javascript/annu_en_us.js"></script>
</body>
</html>