...
<div class="col-sm-10 col-sm-offset-1">
	...
	<table id="acceleration_table" class="table table-striped table-hover">
		<thead><tr><th>Name</th><th>New Rank</th><th>New Grade</th><th>New Title</th><th>New Salary</th><th>New Annual Date</th><th>Action</th></tr></thead>
		<br/><br/>
		<b>
		<tbody>	
		<?php
      ...
      <div class="modal-content" style="background-color: #454d60; ">  
        ...
        <div class="modal-body" style="border-color: #454d60;">	
			...
			<b>
				...
				<div class="form-group">
					<div class="col-sm-6"> <input type="text" class="form-control text-center" id="old_annual" title="Old Annual Date" readonly data-placement="left"></div>
					<div class="col-sm-6"> <input type="text" class="form-control text-center" id="period" title="Acceleration Period" readonly data-placement="right"></div>
				</div>  
			</b></form>
        </div>
