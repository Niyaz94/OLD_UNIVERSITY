...
<div class="row content">
	...
	<table id="annual_table" class="table table-striped table-hover">
		<thead><tr><th>ناو</th><th>پلە</th><th>مەرتەبی کۆن</th><th>مەرتەبی نوێ</th><th>سه‌رمووچه‌ی ساڵانه‌</th><th>کار</th></tr></thead>
		<br/><br/>
		<b>
		<tbody>	
		<?php
      ...
      <div class="modal-content" style="background-color: #454d60; ">  
        ...
        <div class="modal-body" style="border-color: #454d60;">	
			...
			<b>
				...
				<div class="form-group">
					<div class="col-sm-6"> <input type="text" class="form-control text-center" id="title" title="ناونیشانی فەرمانبەر" readonly data-placement="left"></div>
					<div class="col-sm-6"> <input type="text" class="form-control text-center" id="qdam" title=" ژمارەی پێشخستن" readonly data-placement="left"></div>
				</div>  
			</b></form>
        </div>
	...
	<script type="text/javascript" charset="utf8" src="../../../need/DataTables/media/js/jquery.dataTables.js"></script>
  	<script src="../Javascript/annu_ku_us.js"></script>
</body>
</html>