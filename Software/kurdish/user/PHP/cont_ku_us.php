...
<html>
<head>
	<title>په‌یوه‌ندیمان پێوه‌بكه‌</title>
  <meta charset="utf-8">
...
<div class="col-sm-10 col-sm-offset-1" >
     ...
     <div class="col-sm-12  col-xs-8">
         <div style="text-align: right;" class="col-sm-8  col-xs-8">
			<h3>پەیوەندیمان پێوە بکە</h3>
            <p>ئەو فۆڕمەی خوارەوە پڕبکەوە بۆ ئەوەی پەیوەندیمان پێوە بکەی :</p><br><br>
         </div>
	 ...
	 ?>
		<form role="form"  method="post" class="col-sm-8 col-sm-offset-2 col-xs-6">
             <div class="form-group">
				<div id="div_subject" class="has-error has-feedback">
					<input type="text" id="subject" name="subject" placeholder="بابەت..." class="form-control">
             ...
             <div class="form-group">
				<div id="div_message" class="has-error has-feedback">
					<textarea id="message" name="message" placeholder="نامە..." class=" form-control" rows="8" maxlength="250"></textarea>
             ...
             <button id="save" type="button" class="btn btn-primary col-sm-12 col-xs-12" disabled>ناردنی نامە</button>
			 <br>
			 <div id="check" class="form-group "></div>
		</form>
	
      </div></div></div>
                <div class="col-sm-7 col-sm-offset-5 col-xs-12 col-xs-offset-3" >
                  <h3>...یان ئێمە لێرە بدۆزەوە:</h3> <br><br>
                </div>
             
              <div class="row col-sm-12 col-xs-12" style="text-align: center;">
                <div class="col-sm-3 col-xs-6">
                  <h4 class="glyphicon glyphicon-map-marker" ></h4>
                  <p>هەولێر<br>ڕێگای کەرکوک</p>
                </div>
                <div class="col-sm-3 col-xs-6" >
                   <h4 class="glyphicon glyphicon-phone"></h4>
                   <p>مۆبایل:<br>٠٧٧٠ ٢٢٥ ٩٨ ٢٤</p>
                </div>
                <div class="col-sm-3 col-xs-6" >
                   <h4 class="glyphicon glyphicon-envelope"></h4>
                    <p>ئیمەیل:<br><a href="#">contact.Milakat@gmail.com</a></p>
                </div>
                <div class="col-sm-3 col-xs-6" >
                   <h4 class="  glyphicon glyphicon-globe"></h4>
                   <p>سکایپ:<br>milakat_online</p>
                </div>
          </div>
          </div>
