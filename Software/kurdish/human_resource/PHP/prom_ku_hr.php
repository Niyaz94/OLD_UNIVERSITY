...
<html>
<head>
	<title>به‌رزكردنه‌وه‌ی مووچه‌</title>
<meta charset="utf-8">
  ...
  <div class="col-md-2 col-md-offset-1">	
			<form role="form">
				<div class="form-group">
				  <select class="form-control btn btn-primary" id="month_list">
					...
					<option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>کۆن</option><option>نوێ</option>
				  </select>
				</div>
			</form>
	</div>
    <div class="col-md-10 col-md-offset-1">
		...
		<table id="promotion_table" class="table table-striped table-hover table-responsive">
			...
			<thead><tr><th>ناو</th><th>پلەی نوێ</th><th>مەرتەبی نوێ</th><th>مووچەی نوێ</th><th>ب.س.س.ن</th><th>کار</th></tr></thead>
			<br/><br/>
			<tbody>
			</tbody>	
		</table>
   ...
   <div class="modal fade" id="edit_Modal" role="dialog" style="margin-left: auto; margin-right: auto; margin-top: 60px; ">
			...
			<div class="modal-body" style="border-color: #454d60;">	
				...
				<div class="form-group">
					<div id="div_new_title" class="col-md-6 has-success has-feedback">
						<input id="new_title" class="form-control" type="text" placeholder="ناونیشانی نوێ">
					...
					<div id="div_old_title" class="col-md-6 has-success has-feedback">
						<input id="old_title" class="form-control" type="text"  placeholder="ناونیشانی کۆن" >
				...
				<div class="form-group">
					<div id="div_service" class="col-md-6 has-success has-feedback">
						<input id="service" class="form-control" type="text"  placeholder="ماوەی خزمەت" >
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content" style="background-color: #454d60; ">  
        ...
        <div class="modal-body" style="border-color: #454d60;">	
			...
			<b>
				<div class="form-group">
					<div class="checkbox col-sm-12"><label><input id="check_prom" type="checkbox" value="">ڕاگرتنی بەرزکردنەوە</label></div>
				</div>						
			</b></form>
        </div>
        <div class="modal-footer" style="border-color: #454d60;">
	...
	<script src="../Javascript/prom_ku_hr.js"></script>
