...
?>
			...
			<div class="modal-body" style="border-color: #454d60;">	
				...
				<div class="form-group">
					<div id="div_new_title" class="col-md-6 has-success has-feedback">
						<input id="new_title" class="form-control" type="text" placeholder="ناونیشانی فەرمانبەری نوێ">
					...
					<div id="div_old_title" class="col-md-6 has-success has-feedback">
						<input id="old_title" class="form-control" type="text"  placeholder="ناونیشانی فەرمانبەری کۆن" >
	...
	<script src="../Javascript/cert_ku_hr.js"></script>
