...
<br/><br/><br/>
		...
		<div class="modal-dialog modal-sm">
		  <div class="modal-content" style="background-color: #454d60; ">  
			...
			<center><h4 style="color: white;"> بەشی وشەی نهێنی </h4></center></div>
				...
				<b>
					<div class="form-group">
						<div class="col-md-6 col-md-offset-3"><select id="leveel" class="form-control"  >
								<option selected >بەکارهێنەر</option>
								<option>بەڕێوەبەر</option>
						</select></div>	
				</div>							
				</b></form>
			</div>
			<div class="modal-footer" style="border-color: #454d60;">
				<button id="password_save" type="button" class="btn btn-success btn-default pull-right"><span class="glyphicon glyphicon-save"></span>خەزن</button>
			</div>
	   </div></div></div> 
