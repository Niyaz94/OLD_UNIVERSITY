...
<?php include("header_ku_hr.php");?>
  ...
  <div class="row content">
		...
		<div class="col-sm-3 sidenav">	
			<br/>
			<button id="salary_table" type="button" class="col-sm-12 btn btn-info">خشتەی مووچە</button>
			<br/>
			<button id="password" type="button" class="col-sm-12 btn btn-info">وشەی نهێنی</button>
			<br/><br/>
			<button id="button1" type="button" class="col-sm-12 btn btn-info">ساڵانە</button>
			<br/>
