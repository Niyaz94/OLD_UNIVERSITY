...
<div class="white ol-lg-3 col-lg-offset-0 col-md-3 col-md-offset-0 col-sm-4 col-sm-offset-0 col-xs-8 col-xs-offset-0">
<b>
...
<div class="container"  >
    <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      <div class="col-md-5 col-md-offset-4 col-sm-6 col-sm-offset-3 col-lg-5   col-lg-offset-4 col-xs-12 col-xs-offset-0">  
      ...
      <input type="text" id="username" name="username" class="form-control " placeholder="أسم كامل" data-toggle="tooltip">
    ...
    <br/><br/>
       ...
       <span  id="span_password1" class="glyphicon glyphicon-ok form-control-feedback"></span>
          <input id="password1" type="password" name="password" class="form-control"  placeholder="كلمة مرور / كلمة السر" data-toggle="tooltip" >
    ...
    <br/>  
	<a  id="loginbt" class="btn btn-success col-md-12 col-lg-12 col-sm-12 col-xs-12"><div>تسجيل دخول</div></a>	
  </div>
  </form>
</div>
