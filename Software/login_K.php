...
<div class="container"  >
    <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      ...
      <input type="text" name="username" id="username" class="form-control " placeholder=" ناوی ته‌واو" data-toggle="tooltip">
    ...
    <br/><br/>
       ...
       <span  id="span_password1" class="glyphicon glyphicon-ok form-control-feedback"></span>
          <input id="password1" type="password" name="password" class="form-control"  placeholder="ژمارەی نهێنی" data-toggle="tooltip" >
    ...
    <br/>
    	<a  id="loginbt" class="btn btn-success col-md-12 col-lg-12 col-sm-12 col-xs-12"><div>چوونە ژوورەوە</div></a>	
